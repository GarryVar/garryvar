<section class="home">
  ...
  <div class="home__inner container">
    ...
    <p class="home__name">Igor Varekhov</p>
...
<section class="about" id="about_me">
  <div class="about__inner container">
    ...
    <div class="about__content">
      <p class="text about__text about__text--1">Hi, I'm Igor – junior frontend developer from Simferopol. I'm interesting in web development: html, css, native javascript and other frontend technologies</p>
      <p class="text about__text about__text--2">I'm finished courses "Html and css level 1 , level 2 and javascript" in
